(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["UniversalTilt"] = factory();
  else root["UniversalTilt"] = factory();
          ...
          /* WEBPACK VAR INJECTION */ (function (module, global) {
            ...
            (function () {
              ...
              function parse(ua) {
                ...
                /** Detect Rhino. */
                var rhino =
                  java && getClassOf(context.environment) == enviroClass;
                ...
                if (
                  ...
                  name += " Mobile";
                  os =
                    "Windows Phone " + (/\+$/.test(data) ? data : data + ".x");
                  description.unshift("desktop mode");
                }
  ...
  \**********************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _universalTilt = _interopRequireDefault(
            __webpack_require__(
              /*! ./universal-tilt */ "./src/universal-tilt.js"
            )
          );
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function addEventListeners() {
                      ...
                      if (
                        !_platform["default"].name.match(
                          this.settings.exclude
                        ) &&
                        !((_platform$product = _platform["default"].product) ===
                          null || _platform$product === void 0
                          ? void 0
                          : _platform$product.match(this.settings.exclude))
                      ) {
                        if (this.isMobile()) {
                  ...
                  },
                  {
                    ...
                    value: function getValues() {
                      ...
                      var angle =
                        Math.atan2(x - 0.5, 0.5 - y) * (180 / Math.PI);
                      return {
                  ...
                  },
                  {
                    ...
                    value: function transitions() {
                      ...
                      this.timeout = setTimeout(function () {
                        ...
                        if (_this2.settings.shine)
                          _this2.shineElement.style.transition = "";
                      }, this.settings.speed);
                    },
                  },
                  {
                    ...
                    value: function extendSettings(settings) {
                      ...
                      for (var property in defaultSettings) {
                        if (property in settings) {
                          ...
                          this.element.getAttribute("data-".concat(property))
                        ) {
                          var attribute = this.element.getAttribute(
                            "data-".concat(property)
                          );
                      ...
                      try {
                        for (
                          ...
                          if (!("universalTilt" in element)) {
                            element.universalTilt = new UniversalTilt(
                              element,
                              settings,
                              callbacks
                            );
