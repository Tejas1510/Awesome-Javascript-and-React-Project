...
router.post("/test/getquestion", async(req, res) => {
    ...
    try {
        ...
        resModel = await covid.getQnA(payload);
...
// API for contact form 
router.post("/test/askform/submit", async(req, res) => {
    ...
    try {
        ...
        resModel = await covid.postAskQuestion(payload);
...
// API for contact form 
router.post("/test/getanswer", async(req, res) => {
    ...
    try {
        ...
        resModel = await covid.getAnswer(payload);
